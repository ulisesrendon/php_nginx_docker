...
# RUN docker-php-ext-install postgresql-dev
...
# RUN apt install -y postgresql-client docker-php-ext-enable postgresql-client
# RUN apt install -y php_pgsql docker-php-ext-enable php_pgsql
# RUN apt install -y php8.2-pgsql docker-php-ext-enable php8.2-pgsql
